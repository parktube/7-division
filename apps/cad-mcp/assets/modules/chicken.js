...
function makeChicken(id, wx, wy, scale) {
  const s = scale || 1;
  registerIsoGroup('chicken' + id, wx, wy);
  ...
  box3d(n+'butt', wx + P.butt.x*s, wy + P.butt.y*s, P.butt.z*s,
        P.butt.w*s, P.butt.d*s, P.butt.h*s,
        C.white.t, C.white.l, C.white.r);
  
  // 머리 파츠
  box3d(n+'comb', wx + P.comb.x*s, wy + P.comb.y*s, P.comb.z*s,
  ...
  box3d(n+'beak', wx + P.beak.x*s, wy + P.beak.y*s, P.beak.z*s,
        P.beak.w*s, P.beak.d*s, P.beak.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'wattle', wx + P.wattle.x*s, wy + P.wattle.y*s, P.wattle.z*s,
        P.wattle.w*s, P.wattle.d*s, P.wattle.h*s,
        C.pink.t, C.pink.l, C.pink.r);
  
  // 뒷다리 + 발등 + 뒷발
  box3d(n+'leg_back', wx + P.leg_back.x*s, wy + P.leg_back.y*s, P.leg_back.z*s,
        P.leg_back.w*s, P.leg_back.d*s, P.leg_back.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'instep_back', wx + P.instep_back.x*s, wy + P.instep_back.y*s, P.instep_back.z*s,
        P.instep_back.w*s, P.instep_back.d*s, P.instep_back.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'toe_back_outer', wx + P.toe_back_outer.x*s, wy + P.toe_back_outer.y*s, P.toe_back_outer.z*s,
        P.toe_back_outer.w*s, P.toe_back_outer.d*s, P.toe_back_outer.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'toe_back_inner', wx + P.toe_back_inner.x*s, wy + P.toe_back_inner.y*s, P.toe_back_inner.z*s,
        P.toe_back_inner.w*s, P.toe_back_inner.d*s, P.toe_back_inner.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  
  // 앞다리 + 발등 + 앞발
  box3d(n+'leg_front', wx + P.leg_front.x*s, wy + P.leg_front.y*s, P.leg_front.z*s,
        P.leg_front.w*s, P.leg_front.d*s, P.leg_front.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'instep_front', wx + P.instep_front.x*s, wy + P.instep_front.y*s, P.instep_front.z*s,
        P.instep_front.w*s, P.instep_front.d*s, P.instep_front.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'toe_front_inner', wx + P.toe_front_inner.x*s, wy + P.toe_front_inner.y*s, P.toe_front_inner.z*s,
        P.toe_front_inner.w*s, P.toe_front_inner.d*s, P.toe_front_inner.h*s,
        C.orange.t, C.orange.l, C.orange.r);
  box3d(n+'toe_front_outer', wx + P.toe_front_outer.x*s, wy + P.toe_front_outer.y*s, P.toe_front_outer.z*s,
